...
const translations: Record<Lang, Translations> = {
  en: {
    ...
    whereToBuy: {
      ...
      subtitle: "Brightex products are available through our trusted network of distributors across North Africa and the Middle East. Contact us for the nearest point of sale.",
    },
    use: {
      label: "How To Use",
      title: "Application",
  ...
  fr: {
    ...
    whereToBuy: {
      ...
      subtitle: "Les produits Brightex sont disponibles à travers notre réseau de distributeurs de confiance en Afrique du Nord et au Moyen-Orient. Contactez-nous pour le point de vente le plus proche.",
    },
    use: {
      label: "Utilisation",
      title: "Guide",
  ...
  ar: {
    ...
    whereToBuy: {
      ...
      subtitle: "منتجات برايتكس متوفرة عبر شبكتنا الموثوقة من الموزعين في شمال أفريقيا والشرق الأوسط. اتصل بنا لمعرفة أقرب نقطة بيع.",
    },
    use: {
      label: "الاستخدام",
      title: "دليل",
